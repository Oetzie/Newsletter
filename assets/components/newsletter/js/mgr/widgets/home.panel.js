		...
		items		: [{
			...
			items		: [{
				...
				items		: [{
		            ...
		            html			: 0 == parseInt(MODx.config.newsletter_cronjob) ? '<p>' + _('newsletter.newsletter_cronjob_desc') + '</p>' : '',
					bodyCssClass	: 0 == parseInt(MODx.config.newsletter_cronjob) ? 'modx-config-error' : ''
	            }, {
